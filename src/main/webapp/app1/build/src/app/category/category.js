angular.module( 'ngBoilerplate.category', ['ui.router','ngResource'])
    ...
    .controller( 'CategoryCtrl', ["$scope", "sessionService", function CategoryCtrl($scope,sessionService) {
