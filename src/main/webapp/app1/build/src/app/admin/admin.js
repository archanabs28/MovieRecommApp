angular.module( 'ngBoilerplate.admin', ['ui.router','ngBoilerplate.auth','chart.js'])
    ...
    .factory('getMovies', ["$resource", function ($resource) {
        return $resource('/movies');
    }])

    .factory('getUsers', ["$resource", function ($resource) {
    ...
    .factory('getUserDataById', ["getUserData", function (getUserData) {
        var user = {};
        user.user = function(id){
    ...
    .controller('UserStatsCtrl', ["$scope", "getUserDataById", "$stateParams", function AdminMovieStatsCtrl( $scope,getUserDataById,$stateParams ) {
    ...
    .controller('AdminMoviesCtrl', ["$scope", "getMovies", "$timeout", "$state", function AdminMoviesCtrl( $scope,getMovies,$timeout,$state ) {
    ...
    .controller('AdminUsersCtrl', ["$scope", "getUsers", "$state", function AdminUsersCtrl( $scope,getUsers,$state ) {
    ...
    .controller('AdminCtrl', ["$scope", "sessionService", "updateUser", "movieService", "getUserDataById", function AdminCtrl( $scope,sessionService,updateUser,movieService,getUserDataById ) {
