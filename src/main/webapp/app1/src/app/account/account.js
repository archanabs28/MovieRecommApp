angular.module( 'ngBoilerplate.account', ['ui.router','ngBoilerplate.auth'])
    ...
    .factory('BollywoodMoviesFactory', function ($resource) {
    ...
    .factory('commonCount', function ($resource) {
        var stats = {};
    ...
    .controller( 'AccountCtrl', function AccountCtrl( $scope,$timeout,sessionService,updateUser,commonCount,languageTrend ) {
    ...
    .controller( 'ListCtrl', function ListCtrl( $scope,sessionService,$stateParams,getMoviesbyType,BollywoodMoviesFactory ) {
        $scope.user = sessionService.getLoggedInUser();
